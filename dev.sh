...
# on :$GROVE_PORT, serving spaces under ./spaces and ~/spaces (default space: demo). Ctrl+C stops both.
#
...
echo "grove -> app http://${VITE_HOST}:${VITE_PORT}  ·  server :${GROVE_PORT}  ·  spaces ${GROVE_SPACES_ROOTS} (default ${GROVE_DEFAULT_SPACE})"
